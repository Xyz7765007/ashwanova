...
export default function Applications() {
  const formats = [
    { icon: <Icon.Pill />, title: 'Tablets', body: 'Sustained-release dosing in a familiar pharmaceutical form.' },
    { icon: <Icon.Bottle />, title: 'Capsules', body: 'Optimized for once-daily compliance.' },
    { icon: <Icon.Gummy />, title: 'Gummies', body: 'Taste-masked compatibility for chewable formats.' },
    { icon: <Icon.Can />, title: 'Ready-to-Drink', body: 'Stable, dispersible, neutral-tasting.' },
    { icon: <Icon.Stick />, title: 'Stick Packs', body: 'On-the-go convenience without flavor compromise.' },
  ];
  return (
    <section className="section-pad" id="applications">
      <div className="container">
        <div style={{ textAlign: 'center' }}>
          <span className="eyebrow" style={{ color: 'var(--coffee-700)' }}>FORMATS</span>
